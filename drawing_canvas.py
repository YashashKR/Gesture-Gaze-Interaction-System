...
# UI sizes
sidebar_height = 60   # taller top bar
canvas_height = 720
canvas_width = 1280

# Palette box size
palette_size = 60
palette_start_y = 40   # 👈 shifted upwards
...
def draw_button_bar_on_frame(frame):
    ...
    if current_color == (255,255,255):  # eraser selected
...
def draw_color_preview(frame):
    ...
    # Filled rectangle with current color
